...
<div id="divToPrint">
    ...
    <div class="wraper"> 
        ...
        <div class="col-lg-12 container contant-wraper">
			...
			<div>
                ...
                <table class="table table-bordered" style="width:80%;margin-left:5%" id="htmltable">
                    ...
                    <?php
                        ...
                        ?>
                        <tr><td colspan='2'>Total</td><td><?=$tot_amnt_cr?></td></tr>
                    </tbody>
         ...
         <br>
		 <p style="margin-left:5%">LESS:-</p>
		    <table class="table table-bordered" style="width:42%;margin-left:15%" id="htmltable">

                    <tbody style = "text-align: center">

                    <?php foreach($purchase_sale_details as $val) ;?>
                            <tr>
                                <td><?php if(isset($val->item_name)) { echo $val->item_name; }?><!-- /QUINTAL --></td>
                                <td><?php //echo date("d.m.y",strtotime($key->mr_date)); ?></td> 								
                            <!--    <td><?php //echo $tot_qty; ?></td>  -->
                                <td><?php echo round($tot_sb_amt*.01); ?></td>
								<td><?php echo '(-)'.round($tot_sb_amt*.01); ?></td>
                            </tr>
							<tr>
                                <td colspan="3"><?php //echo($key->mr_no); ?></td>
                                <td><?php echo round($tot_sb_amt*.01); ?></td> 								
                                <td><?php echo $tot_amnt_cr- (round($tot_sb_amt*.01));
											    $payment = $tot_amnt_cr- (round($tot_sb_amt*.01));
								?></td>
                            </tr>
