...
'.billPrintWrapper .printBottom .col-md-3{width: 100%; max-width: 33%; padding: 0 0; float: left; box-sizing: border-box;}' +								  
	...
	<div class="rightDate">Dated:27.10.2021</div>
	</div>
	<div class="printTop023">
	...
	<div class="printTop023">
	<div class="leftNo">Debit - Suspense (Sales - ARP,ICDS) A/C- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rs.<?php echo $amt->tot_rcv;?>=00</div>
	...
	<div class="printTop023">
	<div class="leftNo">Credit - Sales (Non-Tax,ARP,ICDS) A/c- </div>
	<div class="rightDate">Rs.<?php echo $amt->tot_rcv;?>=00</div>
	</div>
	<div class="printTop023">
	...
	<?php   $payment_time = '00/00/0000';
			if(isset($payment_detail->trans_dt)){
	...
	<p>Particulars- Being the amount received on Suspense A/C MR No.
	
		<?php  echo rtrim($mr_string,","); ?> dated : <?=$mr_dates;?></span></p></br>	
	Now adjusted with sales.
    </br>	
