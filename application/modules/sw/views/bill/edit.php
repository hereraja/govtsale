<div class="wraper">      
	<div class="col-md-12 container form-wraper" style="margin-left: 0%;">
		<form method="POST" id="form" role="form" name="add_form" action="<?php echo site_url("sw/editswbill");?>" onsubmit="return validate()" >
				...
				<table class="table">
					...
					<?php   $sb_amt = 0;
						...
						<tr>
							...
							<select name="project" id="project" class="form-control " required  style="width:135px">
							...
							<td>
							<select name="hsn_no" id="project" class="form-control " required  style="width:126px">
								<option value="">Select Project  </option>
								<?php
							...
							<td><input type="date"  class="form-control s_bill_dt"  style="width:121px" name="s_bill_dt"  value="<?php if(isset($bill_dtls->s_bill_dt)) echo $bill_dtls->s_bill_dt ;?>" required></td>
							...
							<td><input type="text"  class="form-control s_bill_amt"  style="width:95px" name="s_bill_amt" value="<?php if(isset($bill_dtls->s_bill_amt)) {echo $bill_dtls->s_bill_amt ; $sb_amt+=$bill_dtls->s_bill_amt ; }?>" required></td>
