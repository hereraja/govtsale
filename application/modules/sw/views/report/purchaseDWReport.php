    ...
    <div class="wraper"> 
        ...
        <div class="col-lg-12 container contant-wraper">
            ...
            <div class="col-sm-9 float-left logoTextSecRight">
									...
									<h3>Purchase Details From: <?php echo date("d-m-y",strtotime($startDt)).' To: '.date("d-m-y",strtotime($endDt)) ; ?></h3>
    ...
    $(function () {
        $("#btnExport").click(function () {
            $("#htmltable").table2excel({
                filename: "Purchase Details From: <?php echo date("d-m-y",strtotime($startDt)).' To: '.date("d-m-y",strtotime($endDt)) ; ?>.xls"
            });
        });
    });
</script>
