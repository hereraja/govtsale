<?php
	...
	public function add_payment()
	{
        ...
        $data['banks'] = $this->SocialW->f_select('md_bank',NULL,NULL,0);
	...
	public function savemr(){
		...
		if($this->input->post('id') ==''){
			...
			if($_SERVER['REQUEST_METHOD']=="POST")
			{
				...
				$this->SocialW->mr_detail_entry($paymentkey,$trans_dt,$mr_no,$mr_dt,$bank,$trans_mode,$pay_dt,$mr_amt,$amt,$Unit_count,$created_by,$created_dt);
