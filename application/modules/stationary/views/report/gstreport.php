...
<?php if($_SERVER['REQUEST_METHOD']=="POST") { ?>
        ...
        <div class="col-lg-12 container contant-wraper">
                ...
                <div class="item_body">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h4><?php
                                ...
                                { ?>
                                     <?php  if($key1->sl_no == $supplier_id) echo $key1->name; ?>
                                <?php
            ...
            <div>
                ...
                <table class="table table-bordered" style="width: 100%;">
                    <thead >
                       <tr>
                            <th rowspan='2' style = "vertical-align:middle;text-align: center;">Sale Bill NO</th> 
    ...
    <button class="btn btn-primary" type="button" onclick="location.href='<?php echo base_url('index.php/stationary/gstreport');?>'">Back</button>
...
<div class="col-md-6 container form-wraper">
    ...
    <form role="form" method="POST" action= "<?php echo site_url('stationary/gstreport') ?>" >
