    ...
    <form method="POST" id="form" role="form" name="add_form" action="<?php echo site_url("stationary/updateNewProject");?>" onsubmit="return validate()" >
        ...
        <?php foreach($data1 as $key) { ?>
            ...
            <div class="form-group row">
                ...
                <label for="phn_no" class="col-sm-2 col-form-label">Account Head:</label>
                
                <div class="col-sm-8">

                    <input type="text" name="acc_code" value= "<?php echo $key->acc_code; ?>" class="form-control" id="acc_code" readonly>
