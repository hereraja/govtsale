...
<div class="wraper">      
    ...
    <div class="col-lg-12 container contant-wraper">    
        ...
        <h3>
            <small><a href="<?php echo site_url("stationary/addbank");?>" class="btn btn-primary" style="width: 100px;">Add</a></small>
            ...
            <tbody class= "tbody">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="<?php echo site_url('stationary/editbank/'.$key->sl_no.' '); ?>" ><i class="fa fa-edit fa-fw fa-2x"></i></a></td>
