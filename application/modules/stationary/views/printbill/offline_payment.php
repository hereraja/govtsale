...
'.billPrintWrapper .printBottom .col-md-3{width: 100%; max-width: 33%; padding: 0 0; float: left; box-sizing: border-box;}' +								  
	...
	<div class="printTop023">
		<?php   $payment_time = '00/00/0000';
          ...
          // If Mr Date is different in multiple  //
	...
	<div class="rightDate">Dated: <?=$mr_dates;?></div>
	</div>
		
	<div class="debitLine"><p><strong>Debit :</strong> <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sundry Creditors &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A/c</span></p></div>
	<div class="billTxtArea">
	
	
	<p>Being the ammount paid to <strong class="italic">"Yourselves" </strong>A/c. <strong class="italic"><?=$payment_detail->vendor_name;?></strong>.through RTGS/NEFT  by cheque no ___________ dated <?=$mr_dates;?> </strong>on <strong class="italic"><?=$payment_detail->bank_name;?></strong>, for supply of
