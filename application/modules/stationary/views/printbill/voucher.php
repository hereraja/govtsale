...
'.billPrintWrapper .printBottom .col-md-2{width: 100%; max-width: 19%; padding: 0 0; float: left; box-sizing: border-box;}' +								  
	...
	<div class="wrapper">
		<div id="divToPrint">
			...
			<h2>BARRACKPORE CENTRAL ZONE WHOLESALE CONSUMERS' COOPERATIVE SOCIETY LIMITED
			<span>87, MADHUPANDIT  ROAD, P.O-TALPUKUR, 24 PARGANAS (NORTH) ,700123</span></h2>
			<?php   $payment_time = '00/00/0000';
					...
					foreach($purchase_sale_details as $key){
						$tot_sb_amt += $key->s_bill_amt;
						$tot_pb_gst += $key->p_cgst;
					}
					...
					if($tot_pb_gst > 1) {
					$tot_mr = $tot_sb_amt-($shortage->sb_less_amt)-($shortage->less_gst)-($shortage->confed_margin)+($shortage->add_gst);
					}else{
					$tot_mr = $tot_sb_amt-($shortage->sb_less_amt)-($shortage->less_gst)-($shortage->confed_margin);	
					}
			...
			<p>Being the ammount paid to <strong class="italic"><?php if(isset($shortage->name)){ echo $shortage->name;}  ?> </strong>through Online  from Axis Bank Ltd, Ganesh Chandra Avenue Branch (Ac/. No. 921010026595729)<strong class="italic"> </strong>For supply of stationery item	Vide bill no. mention in note sheet page no.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Confed bill no also mention in note sheet page no.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;) of file No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;againt <strong class="italic">M.R. No.
			<?php  echo rtrim($mr_string,","); ?> dated : <?=$mr_dates;?></span></p></br>	
			<p><strong>Rupees:</strong> <strong class="italic"><?php echo getIndianCurrency($tot_mr); ?></strong></p>
			<br>	
					<div class="priceSec">Rs. <?php echo $tot_mr;?> </div>
			</div>
